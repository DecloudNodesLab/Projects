...
*Sentinel dVPN предлагает пользователям развернуть dVPN сервера по всему миру, объеденившись в децентрализованную сеть. Владельцы dVPN нод получают вознаграждение в токенах dvpn за каждый гигабайт прошедший через их ноду. Пользователи клиентской части Sentinel dVPN, могут выбирать среди нод - к какой они могут подключится, которая их устроит по скрости передачи информации, геогрфическому положению и конечно цене.
...
Также, если открыть Ваш адрес sentinel в Explorer, Вы можете увидеть наличие транзакции обновления статуса Вашей dVPN ноды.
