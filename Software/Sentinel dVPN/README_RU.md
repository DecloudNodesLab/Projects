...
3. Пополните счет созданного dVPN аккаунта не менее, чем на `150dvpn` (~$0.10) для оплаты газа. Приобрести dvpn вы можете на биржах, например `OSMOSIS` или `KUKOIN`.
